...
const CARDS_CONFIG = [
  {
    id: 'multicloud',
    images: [ { src: 'assets/multi_cloud.png', alt: 'Cloud Native' } ]
  },
  {
    id: 'software',
    images: [ { src: 'assets/SolutionsArchitect.webp', alt: 'Software de Élite' } ] // 👈 Ruta para tu nueva imagen
  },
  {
    id: 'ai',
    images: [ { src: 'assets/MachineLearning.png', alt: 'IA' } ] // 👈 Imagen de IA restaurada
  },
  {
    id: 'aws',
...
const SECTION_TEXTS: any = {
  ES: {
    heroTitlePrefix: "Lideramos la Nube: ",
    heroTitleHighlight: "AWS Select Partners",
    heroTitleSuffix: " y Expertos en Ecosistemas Multi-Cloud.",
    heroSub: "", 
    ctaButton: "COMIENZA LA TRANSFORMACIÓN",
    advantageTitle: "Ventaja Competitiva",
    advantageDesc: "Creamos tecnología que no caduca. No solo configuramos la nube; programamos software robusto y automatizamos infraestructuras para que tu empresa sea imparable.",
    specialtiesTitle: "Nuestras Especialidades",
    cards: {
      multicloud: { label: 'Cloud-Native', title: 'Ingeniería Cloud-Native', desc: 'Fusionamos código de alto nivel con nubes globales. Desarrollamos aplicaciones que escalan solas, son seguras y están siempre disponibles.' },
      software: { label: 'Software de Élite', title: 'Software de Élite', desc: 'Ingeniería de software de alta precisión. Construimos sistemas modulares, rápidos y preparados para crecer al ritmo de tu empresa.' },
      ai: { label: 'Inteligencia Artificial', title: 'Soluciones de IA Avanzada', desc: 'Integración de LLMs para automatizar decisiones críticas.' }, // 👈 IA restaurada
      aws: { label: 'AWS Partners', title: 'AWS Select Partners', desc: 'Estrategias validadas por Amazon. Desplegamos entornos seguros, estables y certificados bajo los más altos estándares globales de AWS.' },
      finops: { label: 'FinOps', title: 'Estrategia FinOps', desc: 'Optimización financiera en tiempo real. Reducimos el gasto innecesario transformando tu nube en una inversión inteligente y rentable.' }
    }
  },
  EN: {
    ...
    <section className="services-section">
      ...
      <div className="content-grid">
        ...
        <div className="left-column">
          <div style={{ marginBottom: 'clamp(20px, 4vw, 40px)' }}>
            ...
            <button
              onClick={() => navigate(`/${urlLang || 'es'}/contacto`)}
      ...
      <style>{`
        ...
        @media (min-width: 1000px) and (max-width: 1399px) {
          .specialty-card {
            flex-direction: row; align-items: center; min-height: 380px;
          }
          .card-text-col { flex: 0 0 35%; min-width: 0; margin-right: 25px; }
          .card-img-col { flex: 1; justify-content: center; height: 100%; }
        ...
        /* ========================================================= */
        @media (max-width: 480px) {
          .services-section { padding: 220px 20px 220px !important; }
          .content-grid { grid-template-columns: 1fr; gap: 40px; }
          .main-heading { font-size: 2rem; margin-bottom: 20px; }
          .specialty-card { padding: 25px 20px; }
          .card-img-single { max-height: 180px; }
...
const CardContent = ({ data }: { data: any }) => {
  ...
  // Actualizamos la lógica para que tome las 3 tarjetas de imagen simple/secundaria
  const isSecondaryImage = data.id === 'software' || data.id === 'finops' || data.id === 'ai';
  ...
  return (
    <div style={{
      ...
      <div className="card-text-col">
        ...
        <div style={{ width: '40px', height: '4px', background: '#FAA918', margin: '0 0 15px 0' }}></div>
