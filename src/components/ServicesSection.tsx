import React, { useState } from 'react'; // 👈 Se quitó useEffect porque ya no hace falta
...
{/* 👇 3. ACTUALIZAMOS EL ENLACE PARA QUE INCLUYA EL IDIOMA (/es/contacto o /en/contacto) */}
<button
